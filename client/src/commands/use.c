...
{
    memset(client->context.channel_uuid, 0, sizeof(client->context.channel_uuid));
    memset(client->context.team_uuid, 0, sizeof(client->context.team_uuid));
    memset(client->context.thread_uuid, 0, sizeof(client->context.thread_uuid));
    fprintf(stdout, "Context has been reset\n");
}

static void use_team(c_client_t *client, char **args)
{
    memcpy(client->context.team_uuid, args[1], sizeof(client->context.team_uuid));
    memset(client->context.channel_uuid, 0, sizeof(client->context.channel_uuid));
    memset(client->context.thread_uuid, 0, sizeof(client->context.thread_uuid));
...
{
    memcpy(client->context.team_uuid, args[1], sizeof(client->context.team_uuid));
    memcpy(client->context.channel_uuid, args[2], sizeof(client->context.channel_uuid));
    memset(client->context.thread_uuid, 0, sizeof(client->context.thread_uuid));
...
static void use_team_channel_thread(c_client_t *client, char **args)
{
    memcpy(client->context.team_uuid, args[1], sizeof(client->context.team_uuid));
    memcpy(client->context.channel_uuid, args[2], sizeof(client->context.channel_uuid));
    memcpy(client->context.thread_uuid, args[3], sizeof(client->context.thread_uuid));
